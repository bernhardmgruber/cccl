...
void assert_equal(
  ...
  int lineno                  = -1)
{
  using difference_type = THRUST_NS_QUALIFIER::detail::iter_difference_t<ForwardIterator1>;
  using InputType       = THRUST_NS_QUALIFIER::detail::iter_value_t<ForwardIterator1>;
