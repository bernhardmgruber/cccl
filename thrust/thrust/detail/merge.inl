  ...
  StrictWeakCompare comp)
{
  ...
  _CCCL_IF_CONSTEXPR (std::is_null_pointer<StrictWeakCompare>::value)
  {
  ...
  Compare comp)
{
  ...
  _CCCL_IF_CONSTEXPR (std::is_null_pointer<Compare>::value)
  {
    return merge_by_key(
      ...
      StrictWeakOrdering comp)
{
  ...
  System2 system2;
  System3 system3;
  _CCCL_IF_CONSTEXPR (std::is_null_pointer<StrictWeakOrdering>::value)
  {
