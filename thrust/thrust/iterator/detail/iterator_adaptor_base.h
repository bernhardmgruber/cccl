...
{
private:
  using value     = replace_if_use_default<Value, lazy_trait<iter_value_t, Base>>;
  ...
  using reference =
    replace_if_use_default<Reference,
                           ::cuda::std::_If<::cuda::std::is_same_v<Value, use_default>,
                                            lazy_trait<iter_reference_t, Base>,
                                            ::cuda::std::add_lvalue_reference<Value>>>;
  using difference = replace_if_use_default<Difference, lazy_trait<iter_difference_t, Base>>;
