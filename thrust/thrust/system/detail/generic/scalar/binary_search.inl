...
{
  ::cuda::std::iter_difference_t<RandomAccessIterator> n = last - first;
...
_CCCL_HOST_DEVICE bool binary_search(RandomAccessIterator first, RandomAccessIterator last, const T& value, Compare comp)
{
