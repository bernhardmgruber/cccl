...
struct lbf
{
  ...
  _CCCL_HOST_DEVICE typename ::cuda::std::iterator_traits<RandomAccessIterator>::difference_type
...
_CCCL_HOST_DEVICE ForwardIterator lower_bound(
  ...
  StrictWeakOrdering comp)
{
  using difference_type = typename ::cuda::std::iterator_traits<ForwardIterator>::difference_type;
