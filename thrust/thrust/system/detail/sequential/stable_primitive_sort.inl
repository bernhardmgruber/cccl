...
struct enable_if_bool_sort
    : ::cuda::std::enable_if<::cuda::std::is_same<bool, thrust::detail::iter_value_t<Iterator>>::value>
{};

template <typename Iterator>
struct disable_if_bool_sort
    : thrust::detail::disable_if<::cuda::std::is_same<bool, thrust::detail::iter_value_t<Iterator>>::value>
{};
