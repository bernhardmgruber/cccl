...
public:
  using _Target = _LIBCUDACXX_NODEBUG_TYPE _Fp;
  using _Alloc  = _LIBCUDACXX_NODEBUG_TYPE _Ap;
...
{
  using __block_type = _Rp1 (^)(_ArgTypes1...);
  __block_type __f_;
...
#  ifndef _LIBCUDACXX_ABI_OPTIMIZED_FUNCTION
  using __func = __function::__value_func<_Rp(_ArgTypes...)>;
#  else
